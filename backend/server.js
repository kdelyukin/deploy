...
app.put("/api/private/addlist", authenticateToken, async (req, res) => {
...
// Updates the list information
  app.put("/api/private/updateList", authenticateToken, async (req, res) => {
...
app.get("/api/private/userlists", authenticateToken, async (req, res) => {
  try {
    const user = await User.findById(req.user.userId);
    if (!user) {
      return res.status(404).json({ message: "User not found." });
  ...
  //Delete a list
  app.delete("/api/private/deletelist/:listName", authenticateToken, async (req, res) => {
...
// Add destination to the list
  app.put("/api/private/adddestination", authenticateToken, async (req, res) => {
...
app.delete("/api/private/deletedestination", authenticateToken, async (req, res) => {
  const { listName, destination } = req.body;
...
app.get("/api/private/publiclists", authenticateTokenOptional, async (req, res) => {
  try {
...
app.post("/api/private/:userId/lists/:listName/review", authenticateToken, async (req, res) => {
...
app.get("/api/public/:userId/lists/:listName/reviews", async (req, res) => {
  const { userId, listName } = req.params;
